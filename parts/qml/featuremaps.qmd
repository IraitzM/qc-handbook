...
data must be in the regime where those rotations take effect ($[0, 2\pi]$) and may be more suitable if a cyclic nature is already present. Normalization of data may be relevant preprocessing step in this case but we should also pay attention at the rotation axis, $Z$ in this case.
