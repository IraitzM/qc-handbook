...
We will do a simple example so that the formalism of this algorithm is clear to everyone. We will need for this exercise:

* An initial Hamiltonian and its ground state
* A final Hamiltonian
...
There you go, the obtained state corresponds to the desired
