...
Considering it the initial point, we could use our function to iterate over it and select a gradient-free optimizer to try to find a better parameterization.
...
Well let's then do it the ML (machine learning) way and try the available options:
