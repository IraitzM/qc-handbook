...
And many more. They also include nice simulators for GPU based simulation, based on [NVIDIA cuQuantum SDK](https://developer.nvidia.com/cuquantum-sdk) via [Lightning](https://www.xanadu.ai/products/lightning/) which will be really helpfull when we start talking about [training circuits](../algorithms/optimizingcircuits.ipynb).

Let's keep it simple for now and deal with what algorithms we will implement.
