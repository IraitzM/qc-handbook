...
Most likely, as it has happened with the rest of the machines, they will grow into the direction of digitized operation. A hint on previously mentioned _native_ gates: defining a set of parameters that translate our device Hamiltonian to the gates we would like to use, is part of the magic many hardware providers perform through programming frameworks so that we don't have to worry too much about it.
...
That way it is quite simple to understand which atomic operations are required and have a programming language that abstracts us from signals and pulses.
