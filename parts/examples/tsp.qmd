...
for u, v in G.edges:
    for pos in range(N):
        ...
        try:
            ...
            value = G[v][u]["weight"] # Non existent route cost
...
We could of course, once there is a quantum mechanical procedure, implement it using a [digitized approach](../algorithms/examplesfordaqc.qmd).
